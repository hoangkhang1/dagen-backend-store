<ul id="menu" class="page-sidebar-menu">
    ...
    <li {!! (Request::is('admin/datatables') || Request::is('admin/editable_datatables') || Request::is('admin/dropzone') || Request::is('admin/multiple_upload') || Request::is('admin/custom_datatables')|| Request::is('admin/selectfilter') ? 'class="active"' : '') !!}>
        ...
        <ul class="sub-menu">
            <li {!! (Request::is('danh-muc') ? 'class="active"' : '') !!}>
                <a href="{{ URL::to('danh-muc') }}">
                    <i class="fa fa-angle-double-right"></i>
                    Danh sách
                </a>
            </li>
            <li {!! (Request::is('danh-muc/create') ? 'class="active"' : '') !!}>
                <a href="{{ URL::to('danh-muc/create') }}">
                    <i class="fa fa-angle-double-right"></i>
                    Tạo mới
                </a>
            </li>
    ...
    <li {!! (Request::is('admin/datatables') || Request::is('admin/editable_datatables') || Request::is('admin/dropzone') || Request::is('admin/multiple_upload') || Request::is('admin/custom_datatables')|| Request::is('admin/selectfilter') ? 'class="active"' : '') !!}>
        ...
        <ul class="sub-menu">
            <li {!! (Request::is('san-pham') ? 'class="active"' : '') !!}>
                <a href="{{ URL::to('san-pham') }}">
                    <i class="fa fa-angle-double-right"></i>
                    Danh sách
                </a>
            </li>
            <li {!! (Request::is('san-pham/create') ? 'class="active"' : '') !!}>
                <a href="{{ URL::to('san-pham/create') }}">
                    <i class="fa fa-angle-double-right"></i>
                    Tạo mới
                </a>
            </li>
    ...
    <li {!! (Request::is('doanh-so') ? 'class="active"' : '') !!}>
        <a href="{{ URL::to('doanh-so') }}">
            <i class="fa fa-angle-double-right"></i>
            Doanh số
        </a>
    </li>
    ...
    <li {!! (Request::is('admin/datatables') || Request::is('admin/editable_datatables') || Request::is('admin/dropzone') || Request::is('admin/multiple_upload') || Request::is('admin/custom_datatables')|| Request::is('admin/selectfilter') ? 'class="active"' : '') !!}>
        ...
        <ul class="sub-menu">
            <li {!! (Request::is('don-hang') ? 'class="active"' : '') !!}>
                <a href="{{ URL::to('don-hang') }}">
                    <i class="fa fa-angle-double-right"></i>
                    Danh sách đơn hàng mới
                </a>
                <a href="{{ URL::to('don-hang/sales-history') }}">
                    <i class="fa fa-angle-double-right"></i>
                    Lịch sử đơn hàng
                </a>
            </li>
