...
<head>
    ...
    <!-- global css -->
    <link href="{{ asset('assets/css/khang.css') }}" media="all" rel="stylesheet" type="text/css" />
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="{{url('http://dagen.miennam24h.vn/public/user')}}/{{Auth::user()->store_login_avatar}}" alt="img" height="35px" width="35px"
                   ...
                   {{--@if(Sentinel::getUser()->pic)--}}
                            ...
                            {{--@else--}}
                                {{--<img src="{{ asset('assets/images/authors/no_avatar.jpg') }}" alt="img" height="35px" width="35px"--}}
                                     {{--class="img-circle img-responsive pull-left"/>--}}
                            {{--@endif--}}
                            <p class="topprofiletext">Hoang Khang</p>
                        </li>
                        <!-- Menu Body -->
                        <li>
                            <a href="#">
