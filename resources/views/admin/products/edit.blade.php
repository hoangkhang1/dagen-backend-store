...
@section('title')
    Cập nhật thông tin sản phẩm :: @parent
@stop
            ...
            <div class="col-lg-12">
                <div class="panel panel-primary ">
                    ...
                    <div class="panel-body">
                        {!! Form::open(array('url' => url('san-pham/update',$data->product_id), 'method' => 'post', 'class' => 'form-horizontal', 'files'=> true)) !!}
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input class="col-md-9" name="price"
                                       value="{!! old('total', $data->price) !!}"/>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label">Giá Tham khảo</label>
                                <input class="col-md-9" name="price_reference"
                                       value="{!! old('total', $data->price_reference) !!}"/>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label">Ảnh minh họa</label>
                                {{--<img class="col-md-9"--}}
                                {{--width="180px" height="180px" id="avatar" src="{{url('upload')}}/image.png"--}}
                                {{--alt="your image"/>--}}
                                {{--<input type='file' name="file" onchange="readURL(this)"/>--}}


                                <div class="col-md-2 control-label" data-provides="fileinput">
                                    <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 200px;height: 200px;line-height: 150px;"></div>
                                    <div>
                            ...
                            <div class="form-group">
                                <label class="col-md-2 control-label">Danh Sách Ảnh</label>
                            </div>
